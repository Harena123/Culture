...
<footer class="footer">
    ...
    <script src="<?php echo $url ?>/assets/vendors/progressbar.js/progressbar.min.js"></script>
    ...
    <script src="<?php echo $url ?>/assets/vendors/owl-carousel-2/owl.carousel.min.js"></script>
