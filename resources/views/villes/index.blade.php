      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        ...
        <ul class="nav">
          ...
          <li class="nav-item menu-items active">
            <a class="nav-link active" data-toggle="collapse" href="#basic" aria-expanded="false" aria-controls="ui-basic">
              <span class="menu-icon">
          ...
          <div class="content-wrapper">
            ...
            <div class="row">
              <div class="col-md-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title"> <div class="col-sm-6">
